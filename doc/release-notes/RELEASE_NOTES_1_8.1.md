# HondaisCoin Core 1.8.1

HondaisCoin Core 1.8.1 is primarily a bugfix release, bringing HondaisCoin Core in
line with Bitcoin 0.9.3. HondaisCoin Core 1.8.1 also adds in support for printing
...
## HondaisCoin Core Release Notes

* Translation improvements and corrections
* Disable Transifex based translation process (not used by HondaisCoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 HondaisCoin Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/hondaiscoin/hondaiscoin/issues/134).
