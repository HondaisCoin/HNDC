...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MHNDC);
    unitlist.append(kHNDC);
    unitlist.append(HNDC);
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MHNDC: return QString("MHNDC");
    case kHNDC: return QString("kHNDC");
    case HNDC: return QString("HNDC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MHNDC: return QString("Mega-HondaisCoin (1,000,000 HNDC)");
    case kHNDC: return QString("Kilo-HondaisCoin (1000 HNDC)");
    case HNDC: return QString("HondaisCoin");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MHNDC: return Q_INT64_C(100000000000000);
    case kHNDC: return Q_INT64_C(100000000000);
    case HNDC:  return Q_INT64_C(100000000);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MHNDC: return Q_INT64_C(900000);
    case kHNDC: return Q_INT64_C(900000000);
    case HNDC:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MHNDC: return 6;  // 900,000 (# digits, without commas)
    case kHNDC: return 9;  // 900,000,000
    case HNDC:  return 12; // 900,000,000,000
...
int BitcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case MHNDC: return 14;
    case kHNDC: return 11;
    case HNDC: return 8;
