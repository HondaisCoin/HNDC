...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HondaisCoin"),
     ...
     * override -datadir in the hondaiscoin.conf file in the default data directory
     * (to be consistent with hondaiscoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
