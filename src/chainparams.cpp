...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1.hondaiscoin.com", "seed.hondaiscoin.com"));
        vSeeds.push_back(CDNSSeedData("hondaiscoin.net", "seeds.hondaiscoin.net"));
        vSeeds.push_back(CDNSSeedData("seed2.hondaiscoin.com", "info.hondaiscoin.com"));
        vSeeds.push_back(CDNSSeedData("hndc.allblockchaininfo.xyz", "explorer.hondaiscoin.com"));
        vSeeds.push_back(CDNSSeedData("pool.hondaiscoin.com", "faucet.hondaicoin.com"));

        // Workaround for Boost not being quite compatible with C++11;
        std::vector<unsigned char> pka = list_of(40);
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("45.53.83.111", "159.223.111.166"));
