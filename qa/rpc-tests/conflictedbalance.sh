...
# Copyright (c) 2014 The HondaisCoin Core developers
...
BITCOIND=${1}/hondaiscoind
CLI=${1}/hondaiscoin-cli
...
# B1 should still be able to spend 1000000 (-1 HNDC fee for the successful transaction), because D is conflicted
